...
(rtmdet-sam) ➜  tests git:(master) ✗ python3 test_parse.py --help           
usage: test_parse.py [-h] {init,process} ...

positional arguments:
  {init,process}  Available commands
    init          Initialize something
    process       Process something

optional arguments:
  -h, --help      show this help message and exit
(rtmdet-sam) ➜  tests git:(master) ✗ python3 test_parse.py init --help 
usage: test_parse.py init [-h] [--name NAME]

optional arguments:
  -h, --help   show this help message and exit
  --name NAME  Name parameter for init command
