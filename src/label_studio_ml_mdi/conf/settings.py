...
svs_tile_prefix = "http://mdi.hkust-gz.edu.cn/wsi/metaservice/api/sliceInfo/openslide/"
svs_tile_imageURL = "http://mdi.hkust-gz.edu.cn/wsi/metaservice/api/tile/openslide/"
